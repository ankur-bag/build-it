    ...
    <div className="min-h-screen bg-[#E1E0CC] text-slate-900 selection:bg-slate-200 relative overflow-hidden font-sans">
      ...
      <div className="max-w-7xl mx-auto px-6 pt-28 pb-16 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-10">
          ...
          {/* Engagement score */}
          <div className="bg-white/40 border border-white/60 rounded-[2rem] p-7 relative overflow-hidden transition-colors hover:bg-white/50 backdrop-blur-xl shadow-xl shadow-black/5 flex flex-col justify-between h-44">
            <div className="w-12 h-12 rounded-2xl bg-amber-50 border border-amber-100 flex items-center justify-center mb-4 relative z-10 shadow-sm">
              <VscGraph className="text-amber-500 text-xl" />
            </div>
            <p className="text-[13px] text-amber-600/80 font-bold mb-1 tracking-[0.1em] uppercase absolute top-7 right-7 font-sans">Engagement</p>
            <div className="relative z-10 flex items-baseline gap-1 mt-auto">
              <p className="text-5xl md:text-6xl font-bold font-sans text-amber-500 drop-shadow-[0_2px_10px_rgba(245,158,11,0.2)]">{engagementScore}</p>
              <span className="text-xl text-amber-500/50 font-sans">%</span>
            </div>
            <div className="absolute bottom-0 left-0 right-0 h-1 bg-black/5">
              <div className="h-full bg-amber-400 shadow-[0_0_8px_rgba(245,158,11,0.5)]" style={{ width: `${engagementScore}%` }} />
            </div>
          </div>
        </div>
